...
function BoostBadge({ boostType }: { boostType: "featured" | "urgent" | null }) {
  ...
  if (boostType === "urgent") {
    return (
      <span className="inline-flex shrink-0 items-center rounded-sm bg-chart-3 px-[8px] py-[2px] text-[13px] font-semibold tracking-wide whitespace-nowrap text-primary-foreground uppercase">
        URGENT
      </span>
    );
  }
  ...
  return (
    <span className="inline-flex shrink-0 items-center rounded-sm bg-chart-2 px-[8px] py-[2px] text-[13px] font-semibold tracking-wide whitespace-nowrap text-primary-foreground uppercase">
      FEATURED
    </span>
  );
}
...
export default async function JobsPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background font-sans selection:bg-primary/30">
      {/* Hero Band */}
      <section className="bg-foreground px-6 py-20 text-background md:px-12 lg:px-24 xl:px-32 xl:py-[120px]">
        <div className="mx-auto max-w-7xl">
          ...
          <p className="mt-6 max-w-2xl text-[18px] leading-[1.50] font-normal text-muted-foreground">
      ...
      <section className="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        {jobs.length === 0 ? (
          <div className="py-24 text-center">
            <h2 className="text-[28px] font-medium text-foreground">No open positions</h2>
          ...
          <div className="grid grid-cols-1 gap-[24px] md:grid-cols-2 lg:grid-cols-3">
            {jobs.map((job) => {
              ...
              const cardBg =
                isBoosted && job.boostType === "featured" ? "bg-accent" : "bg-background";
              ...
              return (
                ...
                >
                  ...
                  <div className="mb-4 flex flex-wrap gap-2">
                    ...
                    <span className="inline-flex items-center rounded-sm bg-accent px-[8px] py-[2px] text-[13px] font-semibold whitespace-nowrap text-primary-foreground">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-[16px] text-muted-foreground">{job.companyName}</p>
                  </div>
                  ...
                  {salary !== null && (
                    <p className="mt-3 text-[14px] font-medium text-primary-foreground">{salary}</p>
                  )}

                  <p className="mt-4 line-clamp-3 text-[14px] leading-[1.50] text-muted-foreground">
